...
OperationResult<MCStatus, TaskId> task_manager::TaskServiceModelController::Add(
    task_manager::TaskId task_id, task_manager::Task task) {
  grpc::ClientContext ctx;
  TaskIdResponse response;
...
OperationResult<MCStatus> task_manager::TaskServiceModelController::Edit(
    task_manager::TaskId task_id, task_manager::Task task) {
  grpc::ClientContext ctx;
...
OperationResult<MCStatus> task_manager::TaskServiceModelController::Complete(
...
OperationResult<MCStatus> task_manager::TaskServiceModelController::Delete(
    task_manager::TaskId task_id) {
  grpc::ClientContext ctx;
  PlainResponse response;
