...
class IostreamSmallStepFactory : public ISmallStepFactory {
 public:
  ...
  std::shared_ptr<IostreamSmallStep> GetREPLState(IostreamSmallStepEnum sse) override;
 ...
 private:
  ...
  std::shared_ptr<IostreamReadPrioritySmallStep> GetIostreamReadPrioritySmallStep();
