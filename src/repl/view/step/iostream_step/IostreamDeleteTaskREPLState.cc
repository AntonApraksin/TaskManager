...
IostreamDeleteTaskREPLState::IostreamDeleteTaskREPLState(TaskWrappers task_wrappers, const std::shared_ptr<IValidator> &validator)
: IDeleteTaskREPLState(std::move(task_wrappers)), IostreamWithValidatorREPLState(validator) {}
