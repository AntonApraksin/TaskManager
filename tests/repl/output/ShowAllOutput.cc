...
TEST_F(ShowAllOutputTest, RewriteItEveryTimeYouChangeTheSourceCode) {
  ...
  std::vector<std::string> desired_output{
      ...
      IostreamStrings::GetPrompt(""),
      IostreamStrings::ShowTaskWithId(*task_storage.Find(TaskId::Create(0)),
                                      TaskId::Create(0)),
      IostreamStrings::ShowNestedMap(task_storage.Find(TaskId::Create(0)), 3),
      IostreamStrings::ShowTaskWithId(*task_storage.Find(TaskId::Create(3)),
                                      TaskId::Create(3)),
      IostreamStrings::ShowNestedMap(task_storage.Find(TaskId::Create(3)), 3),
      IostreamStrings::ShowTaskWithId(*task_storage.Find(TaskId::Create(4)),
                                      TaskId::Create(4)),
      IostreamStrings::ShowNestedMap(task_storage.Find(TaskId::Create(4)), 3),
      IostreamStrings::GetPrompt(""),
  };
